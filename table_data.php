...
if($query==0)
{
$query_pag_data = "SELECT property_id,property_title,type_of_property,property_city,property_photo from add_properties LIMIT $start, $per_page";
}
if($query==1)
{
...
<td class='edit_td' >
<span id='four_$id' class='text'> <img src= ". $path . " height='35' width='35'></span> 
</td>
...
if($query==1)
{
$query_pag_num = "SELECT COUNT(*) AS count FROM from add_properties WHERE property_city LIKE '%$searchstring%'";
}
